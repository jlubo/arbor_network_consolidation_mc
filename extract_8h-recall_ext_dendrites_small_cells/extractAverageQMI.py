...
# ---------------------------------------------------------------------------------------
# loop over pattern sizes and diffusivities
fout_2 = open(averaged_Q_MI_file, "w")
for pattern_size in [100, 150, 200, 250]:
	for diffusivity_pc in [1e-4, 1e-8, 1e-12]:
		...
		df_selected_trials = df_all_trials[(df_all_trials[1] == pattern_size) & (df_all_trials[2] == diffusivity_pc)]
		...
		print(f"Pattern size {pattern_size}, diffusivity {diffusivity_pc}:")
